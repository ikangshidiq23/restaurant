...
import com.restaurant.faisal.data.Constans;
import com.restaurant.faisal.data.Session;
import com.restaurant.faisal.model.RegisterResponse;
import com.restaurant.faisal.utils.DialogUtils;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public void updateUser() {
        ...
        AndroidNetworking.post(Constans.UPDATE_PROFILE_USER + "/" + session.getUserId()).addBodyParameter
                ("nama", name.getText().toString()).addBodyParameter("old_password", oldPass.getText().toString()).addBodyParameter
                ("new_password", newPass.getText().toString()).build().getAsObject(RegisterResponse.class, new ParsedRequestListener() {
            @Override
